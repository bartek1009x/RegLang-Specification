...
In terms of inspiration from other languages, it draws inspiration mainly from Java, C, C++, Rust, Lua, Luau and maybe even Kotlin or Go? (I'm not sure what exactly inspired me to use the `func` keyword for functions, but I know these languages use it so maybe it were those languages?)
